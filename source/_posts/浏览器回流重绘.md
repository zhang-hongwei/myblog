...
![](https://s2.loli.net/2023/09/01/N6QrwfWOcFPa9K4.png)
...
```js
- 使用cssText
    1. `constel=document.getElementById('test');`
...
function appendDataToElement(appendToElement, data) {
    let li; for (let i = 0; i < data.length; i++) {
...
![](https://s2.loli.net/2023/09/01/94qUybncdQrKDpS.png)
...
![](https://s2.loli.net/2023/09/01/I1j3vPHkrwcsLmY.png)
...
- 在[GPU渲染](https://cloud.tencent.com/solution/render?from_column=20065&from=20065)字体会导致抗锯齿无效。这是因为GPU和CPU的算法不同。因此如果你不在动画结束的时候关闭硬件加速，会产生字体模糊。
